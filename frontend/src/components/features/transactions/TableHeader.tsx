...
export const TableHeader = ({ search, onSearchChange, filterType, onFilterChange }: TableHeaderProps) => {
  return (
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="relative shrink-0">
            ...
            <input
              type="date"
              className="pl-8 pr-2 py-1.5 bg-slate-50 border-none rounded-xl text-[10px] font-bold text-slate-500 uppercase outline-none cursor-pointer w-full"
